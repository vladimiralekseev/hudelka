...
<div class="wrap">
  ...
  <div class="case">
		...
		<?= $this->render('../site/who-to-order');?>
  		<?= $this->render('../site/order', compact('OrderForm'));?>
  		
      <div class="ftr">
      		<p class="contact-phone-footer">Контактный телефон <b>+38 (096) 877 86 17</b></p>
...
<div class="link-to-up"><a href="#" style=""><span class="icon ibranson-fontawesome-webfont-13"></span><span class="name">to top</span></a></div>
...
<script>/*$(document).ready(function(){def_click("count-1");})*/</script>
<script type="text/javascript">
/*    $(function(){

        $('a[href="#"], a[href="#order"]').click(function(){
          $("html, body").animate({scrollTop: $("#order_all").offset().top-300}, 400);
          var count = $(this).attr("data-count")
          count = count ? count : 1;
          def_click("count-"+count);
          return false;
        });

        $('a[href="#effect"], a[href="#expert"], a[href="#properties"], a[href="#reviews"], a[href="#composition"], [href="#how-to-order"]').click(function(e){
          e.preventDefault();
         ...
         $("#country").change(function(){
            ...
            $('.js_price_diff').text(diff+' '+curs);
            $('.js_old_percent_curs').text(Math.ceil(100-new_price/old_price*100));
         }).change();
        })*/
       </script>
